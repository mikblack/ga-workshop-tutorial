...
<img width="50%" style="border:1px solid black" src="images/create_repo.png">
...
<img width="50%" style="border:5px solid black" src="images/edit_readme.png">
...
<img width="50%" style="border:1px solid black" src="images/rendered_readme.png">
